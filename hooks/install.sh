...
#   or:  bash <(curl -s https://raw.githubusercontent.com/pomagrenate/iceage/main/hooks/install.sh)
...
REPO_URL="https://raw.githubusercontent.com/pomagrenate/iceage/main/hooks"
