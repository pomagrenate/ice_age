...
#        irm https://raw.githubusercontent.com/pomagrenate/iceage/main/hooks/install.ps1 | iex
...
$RepoUrl = "https://raw.githubusercontent.com/pomagrenate/iceage/main/hooks"
